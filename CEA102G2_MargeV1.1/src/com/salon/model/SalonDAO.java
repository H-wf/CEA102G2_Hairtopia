...
import com.designer.model.DesignerDAO;
...
public class SalonDAO implements SalonDAO_interface{
	...
	private static final String INSERT_STMT = 
			"INSERT INTO salon (salName,salAdd,salTime,salPhone,salStatus,salLat,salLng) VALUES (?, ?, ?, ?, ?,?,?)";
		private static final String GET_ALL_STMT = 
			"SELECT salNo,salName,salAdd,salTime,salPhone,salStatus FROM salon order by salNo";
		private static final String GET_ONE_STMT = 
			"SELECT salNo,salName,salAdd,salTime,salPhone,salStatus,salLat,salLng FROM salon where salNo = ?";
		private static final String DELETE = 
			"DELETE FROM salon where salNo = ?";
		private static final String UPDATE = 
			"UPDATE salon set salName=?, salAdd=?, salTime=?, salPhone=?, salStatus=? where salNo = ?";
		private static final String GET_SAL_NAME =
			"SELECT salName from salon where salName like ? ";	
