...
<body id="page-top">
	...
	<div class="container-fluid">
		<c:if test="${!empty changePswd}">
			<script type="text/javascript">
				alert('請重新登入');
				location.href = "../staff/staff.do?action=logout";
			</script>
		</c:if>
		<div id="display">
			<h2>${sessionSta.staName}歡迎回來</h2>
			<div id="nowTime"></div>
		</div>
	...
	<script type="text/javascript">
		function now() {
			...
			let combine = '現在時間:' + year + "/" + newMon + "/" + newDate + " "
					+ newHr + ":" + newMin + " " + newSec + "  " + status;
