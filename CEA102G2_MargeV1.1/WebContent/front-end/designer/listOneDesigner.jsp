...
<html>
<head>
<title>設計師資料for前台 - listOneDesigner.jsp</title>
...
<body bgcolor='white'>
	...
	<table>
		...
		<tr>
			<th>班表</th>
			<td><table><c:forEach var="myData" begin="0" end="27" step="4">
		...
		<fmt:parseNumber var="end"
					...
					<td><fmt:formatNumber value="${endHour}" type="number"
						maxFractionDigits="0" />: ${(end*30 %60 == 0)? "00" :"30"}</td></tr>
