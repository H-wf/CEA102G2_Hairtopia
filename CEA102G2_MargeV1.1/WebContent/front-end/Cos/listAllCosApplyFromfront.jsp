...
<table id='mytb' style="width: 77.5rem" class="table table-striped">
	<tr>
		...
		<th style="width: 5.5rem" valign="middle">課程<br>介紹</th>
		...
		<th style="width: 4rem" valign="middle">點選<br>報名</th>
	</tr>
...
<form method="POST" action="<%=request.getContextPath()%>/front-end/Cos/Cart.jsp">
